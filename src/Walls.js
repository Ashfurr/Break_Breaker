class Walls {
    constructor(Tableau1){
        ...
        this.wall.create(3,0,"pad").setOrigin(0.0).setDisplaySize(60,gameConfig.height).refreshBody();
        this.wall.create(gameConfig.width-50,0,"pad").setOrigin(0.0).setDisplaySize(60,gameConfig.height).refreshBody();
